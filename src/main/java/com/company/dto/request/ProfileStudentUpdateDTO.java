...
@AllArgsConstructor
@NoArgsConstructor
public class ProfileStudentUpdateDTO {
    ...
    @NotNull(message = "Guruhingizni kiriting!")
    ...
    @NotNull()
    @Size(min = 3, message = "Ism kiritilshda xatolik, belgilar soni 2 tadan ko'p bo'lish kerak!")
    private String name;
